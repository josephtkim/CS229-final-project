...
from utils import (discriminator_loss, generator_loss, generator_loss_eval, discriminator_loss_eval,
                   compute_distribution_matching_loss, identity_consistency_loss)
